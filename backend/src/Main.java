...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // For example:
        for (Client c : clientsWhosNamesStartWithJ) {
            c.setName("Gaceb");
            c.setSurnameName("Hicham");
            c.edit(); // uses the attributes to update the tuple that has the object's ID in the DB
        }
    ...
    interface Printer {
        ...
        public void print(Vector<Table> tuples, String s);
    }
}
