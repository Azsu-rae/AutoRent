...
public abstract class Table<T extends Table<T>> {
    ...
    public static Vector<Table> search(Vector<? extends Table> discreteCriterias, Vector<Pair<Object,Object>> 
            boundedCriterias) {
    ...
    private static Pair<String,Vector<Object>> scratch(Vector<? extends Table> discreteCriterias, Vector<Pair<Object,Object>> 
            boundedCriterias) {
